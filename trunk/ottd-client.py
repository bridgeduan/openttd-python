...
class IngameChatEvent(Event):
    ...
    """
    def __init__(self, msg, msg2, playerid, playername, parent=None, parentclient=None, self_sent=False):
...
class IngamePublicChatEvent(IngameChatEvent):
    ...
    def __init__(self, msg, clientid, parent=None, parentclient=None):
        if parentclient is None and not parent is None:
            self.parentclient = parent.parentclient
        else:
            self.parentclient = parentclient
...
class IngameTeamChatEvent(IngameChatEvent):
    ...
    """
    distribution = {'ingame': False, 'irc': False, 'log': True}
    def __init__(self, msg, clientid, parent=None, parentclient=None):
        if parentclient is None and not parent is None:
            self.parentclient = parent.parentclient
        else:
...
class IngameTeamChatEventResponse(IngameTeamChatEvent):
    distribution = {'ingame': True, 'irc': False, 'log': True}
    def respond(self, msg):
        pass
    def sendToGame(self):
...
class IngameTeamPrivateEvent(IngameChatEvent):
    """
    ...
    def sendToLog(self):
        if not self.distribution['log']:
            return False
        LOG.info("Ingame private chat: <%s> %s" % (self.playercompany, self.playername,self.msg))
        return True
    def send(self):
        self.sendToGame()
        self.sendToLog()
...
class IngamePrivateChatEventResponse(IngamePrivateChatEvent):
    distribution = {'ingame': True, 'irc': False, 'log': True}
    def respond(self, msg):
        pass
    def sendToGame(self):
...
class SpectatorClient(Client):
    ...
    def processEvent(self, event):
        ...
        if event.__name__() == "IngameChatEvent":
